...
const MainFooter: React.FC = () => {
    return (
        <footer className="main-footer bg-gradient-to-t from-lightCream">
            <div className="top-footer mx-auto h-auto min-h-[28rem] w-full mt-16 relative md:mt-2">
                <div className="container mx-auto w-full h-full px-4 py-6 lg:grid lg:grid-cols-4 lg:gap-x-10 lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:py-16">
                    <div className="mini-about small-to-max">
                        <div className="logo">
                    ...
                    <div className="quick-links mt-8 lg:mt-0 small-to-max">
                    ...
                    <div className="social-media mt-8 lg:mt-0 small-to-max">
                    ...
                    <div className="quick-description mt-8 col-span-4 lg:mt-0 small-to-max">
                ...
                <hr className="container bg-darkCoffee h-[3px] mx-auto absolute bottom-0 left-1/2 -translate-x-1/2 border-none " />
            </div>
            <div className="bottom-footer mx-auto min-h-20 w-full relative">
                <div className="container mx-auto w-full h-full px-4 py-6 lg:flex lg:justify-between lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2">
                    <ul className="lg:flex lg:gap-4 small-to-max">
                    ...
                    <p className={`max-w-5xl mt-4 text-sm text-primaryTextColor lg:text-base ${robotoRegular.className} lg:mt-0 small-to-max`}>Copyright 2024 @&#169; Leo Online Ecommerce</p>
                </div>
            </div>
        </footer>
    )
